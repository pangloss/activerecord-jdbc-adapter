...
virtually any JDBC-compliant database with your JRuby on Rails application.}
  ...
  s.files = ["History.txt", "README.txt", "Rakefile",
    "LICENSE.txt", "lib/activerecord-jdbc-adapter.rb", "lib/arjdbc.rb",
    "lib/jdbc_adapter.rb", "lib/pg.rb",
    ...
    "lib/arel/visitors/compat.rb", "lib/arel/visitors/db2.rb",
    "lib/arel/visitors/derby.rb", "lib/arel/visitors/hsqldb.rb",
    "lib/arel/visitors/sql_server.rb", "lib/arjdbc/db2.rb",
    "lib/arjdbc/derby.rb", "lib/arjdbc/discover.rb",
    "lib/arjdbc/firebird.rb", "lib/arjdbc/h2.rb",
    "lib/arjdbc/hsqldb.rb", "lib/arjdbc/informix.rb",
    "lib/arjdbc/jdbc.rb", "lib/arjdbc/mimer.rb", "lib/arjdbc/mssql.rb",
    "lib/arjdbc/mysql.rb", "lib/arjdbc/oracle.rb",
    "lib/arjdbc/postgresql.rb", "lib/arjdbc/sqlite3.rb",
    "lib/arjdbc/sybase.rb", "lib/arjdbc/version.rb",
    "lib/arjdbc/db2/adapter.rb", "lib/arjdbc/derby/adapter.rb",
    "lib/arjdbc/derby/connection_methods.rb",
    "lib/arjdbc/firebird/adapter.rb", "lib/arjdbc/h2/adapter.rb",
    ...
    "lib/arjdbc/jdbc/adapter.rb", "lib/arjdbc/jdbc/callbacks.rb",
    "lib/arjdbc/jdbc/column.rb", "lib/arjdbc/jdbc/compatibility.rb",
    "lib/arjdbc/jdbc/connection.rb",
    "lib/arjdbc/jdbc/connection_methods.rb",
    "lib/arjdbc/jdbc/core_ext.rb", "lib/arjdbc/jdbc/discover.rb",
    "lib/arjdbc/jdbc/driver.rb", "lib/arjdbc/jdbc/extension.rb",
    "lib/arjdbc/jdbc/java.rb",
    "lib/arjdbc/jdbc/missing_functionality_helper.rb",
    "lib/arjdbc/jdbc/quoted_primary_key.rb",
    "lib/arjdbc/jdbc/railtie.rb", "lib/arjdbc/jdbc/rake_tasks.rb",
    "lib/arjdbc/jdbc/require_driver.rb",
    "lib/arjdbc/jdbc/type_converter.rb", "lib/arjdbc/mimer/adapter.rb",
    "lib/arjdbc/mssql/adapter.rb",
    "lib/arjdbc/mssql/connection_methods.rb",
    "lib/arjdbc/mssql/limit_helpers.rb",
    "lib/arjdbc/mssql/tsql_helper.rb", "lib/arjdbc/mysql/adapter.rb",
    ...
    "lib/jdbc_adapter/rake_tasks.rb", "lib/jdbc_adapter/version.rb",
    "lib/arjdbc/jdbc/adapter_java.jar", "test/abstract_db_create.rb",
    "test/db2_simple_test.rb", "test/derby_migration_test.rb",
    "test/derby_multibyte_test.rb", "test/derby_simple_test.rb",
    "test/generic_jdbc_connection_test.rb", "test/h2_simple_test.rb",
    "test/has_many_through.rb", "test/helper.rb",
    "test/hsqldb_simple_test.rb", "test/informix_simple_test.rb",
    "test/jdbc_common.rb", "test/jndi_callbacks_test.rb",
    "test/jndi_test.rb", "test/manualTestDatabase.rb",
    "test/mssql_db_create_test.rb",
    "test/mssql_identity_insert_test.rb",
    "test/mssql_legacy_types_test.rb",
    "test/mssql_limit_offset_test.rb", "test/mssql_multibyte_test.rb",
    "test/mssql_simple_test.rb", "test/mysql_db_create_test.rb",
    "test/mysql_info_test.rb", "test/mysql_multibyte_test.rb",
    "test/mysql_nonstandard_primary_key_test.rb",
    "test/mysql_simple_test.rb", "test/oracle_simple_test.rb",
    "test/oracle_specific_test.rb", "test/pick_rails_version.rb",
    "test/postgres_db_create_test.rb", "test/postgres_drop_db_test.rb",
    ...
    "test/postgres_table_alias_length_test.rb", "test/simple.rb",
    "test/sqlite3_simple_test.rb", "test/sybase_jtds_simple_test.rb",
    "test/activerecord/connection_adapters/type_conversion_test.rb",
    "test/activerecord/connections/native_jdbc_mysql/connection.rb",
    "test/db/db2.rb", "test/db/derby.rb", "test/db/h2.rb",
    "test/db/hsqldb.rb", "test/db/informix.rb", "test/db/jdbc.rb",
    "test/db/jndi_config.rb", "test/db/logger.rb", "test/db/mssql.rb",
    "test/db/mysql.rb", "test/db/oracle.rb", "test/db/postgres.rb",
    "test/db/sqlite3.rb", "test/models/add_not_null_column_to_table.rb",
    "test/models/auto_id.rb", "test/models/data_types.rb",
    "test/models/entry.rb", "test/models/mixed_case.rb",
    "test/models/reserved_word.rb", "test/models/string_id.rb",
    ...
    "rakelib/compile.rake", "rakelib/db.rake", "rakelib/package.rake",
    "rakelib/rails.rake", "rakelib/test.rake",
